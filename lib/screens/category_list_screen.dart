...
import '../main.dart'; // Import the PasswordEntry class
import 'login_1.dart';
import 'regist_1.dart';
import 'regist_3.dart';
import 'regist_5.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                // Navigasi ke halaman login_1.dart
                Navigator.push(
                  context,
          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Regist_1()),
                );
              },
              child: const Text('Go to Regist_1 Page'),
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Regist_3()),
                );
              },
              child: const Text('Go to Regist_3 Page'),
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Regist_5()),
                );
              },
              child: const Text('Go to Regist_5 Page'),
            ),
          ),
        ],
      ),
